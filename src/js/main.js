class sClEntity {
    constructor(opt, callback) {
        ...
        // console.log(typeof this.scl.callback)
        // this.scl.callback()
    }
...
class sCl {
    ...
    addEntity(isFirst = true) {
        if (isFirst) {
            ...
            const renderEntity = (id) => {
                const template = `
                    <div class="place-block__header">
                        <p class="place-block__title">Обработка стекла №${id + 1}</p>
                        <div class="place-block__header-state">
                        ...
                        <div class="inner-block">
                            ...
                            <div class="inner-block__single">
                                ...
                                <div class="calcui-quant__nav">
                                    ...
                                    <span data-calcui-action="addGlass" class="btn btn-default animate-load has-ripple">
                                        <svg class="btn-icon" width="16" height="17" viewBox="0 0 16 17" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7.5 0.75V16.25" stroke="white" stroke-width="2" />
                                            <path d="M15.5 8.75L0 8.75" stroke="white" stroke-width="2" />
                                        </svg>
                                        <span class="btn-text">Добавить стекло</span>
                                    </span>
                                </div>
                            </div>
                        </div>
    ...
    renderList() {
            ...
            this.data.forEach((el, index) => {
                ...
                block.innerHTML += `
                    <div class="place-block-cost__list-title-row">
                        ...
                        <span class="place-block-cost__list-value">0 р.</span>
                    </div>
                `
        ...
        //         this.nodes.listBody.innerHTML += template
        //     })
        //     this.nodes.listBody.innerHTML += `
        //         <div class="place-block-cost__list-item">
        //             <p class="place-block-cost__list-item-text">Действия над стеклами</p>
...
window.addEventListener('load', () => { const calc = new sCl() })